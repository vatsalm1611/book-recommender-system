class AppConfiguration:
    def __init__(self):
        # Set up paths or config values here
        self.trained_model_path = "artifacts/model.pkl"
        self.book_pivot_serialized_objects = "artifacts/book_pivot.pkl"
        self.final_rating_serialized_objects = "artifacts/final_rating.pkl"
